...
def visualize_features(path):
    ...
    #Plot 1
    ax1.scatter(music_normalized[0],music_normalized[6],color='red',s=10)
    ax1.scatter(speech_normalized[0],speech_normalized[6],color='blue',s=10)

    #Plot 2
    ax2.scatter(music_normalized[8],music_normalized[4],color='red',s=10)
    ax2.scatter(speech_normalized[8],speech_normalized[4],color='blue',s=10)

    #Plot 3
    ax3.scatter(music_normalized[2],music_normalized[3],color='red',s=10)
    ax3.scatter(speech_normalized[2],speech_normalized[3],color='blue',s=10)

    #Plot 4
    ax4.scatter(music_normalized[5],music_normalized[7],color='red',s=10)
    ax4.scatter(speech_normalized[5],speech_normalized[7],color='blue',s=10)

    #Plot 5
    ax5.scatter(music_normalized[1],music_normalized[9],color='red',s=10)
    ax5.scatter(speech_normalized[1],speech_normalized[9],color='blue',s=10)
    ...
    ax5.legend(['music','speech'],loc='upper right',fontsize = '11',labelspacing=0.25)
